    ...
    <StyledWrapper>
      <div id="Container">
        <form className="form" onSubmit={handleSubmit}>
          ...
          <input className="form-content" type="email" name="email" value={credentials.email} placeholder="Enter Your Email" onChange={onChange} />
          <input className="form-content" type="password" name="password" value={credentials.password} placeholder="Enter Your PassWord" onChange={onChange} />
          <button type="submit">Login</button>


          <div style={{ marginTop: "1rem", textAlign: "center" }}>
            <p>Don't have an account?</p>
            <button type="button" onClick={() => navigate('/signup')} style={{ padding: '0.5rem 1rem', cursor: 'pointer' }}>
              Sign Up
            </button>
          </div>
